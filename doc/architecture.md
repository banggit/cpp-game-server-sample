...
- **회사에서 봤던 패턴 그대로 가져오지 않기**. 회사 코드에는 libuv 기반 Reactor, ASE_DECLARE_INSTANCE_PTR 류의 매크로 싱글톤, 17종의 EnumMessage 같은 요소들이 있었지만, 작은 샘플에는 맞지 않아 결만 가져오고 형태는 단순화했다.